...
const HeroSection = () => {
  ...
  return (
    <section className="relative py-32 bg-gradient-to-r from-blue-600 to-blue-400 overflow-hidden">
      <div
        className="absolute inset-0 bg-[url('/hero-pattern.svg')] bg-cover opacity-10 transform transition-transform duration-700 hover:scale-105"
      />
      <div
        className="container mx-auto px-4 relative z-10 transform transition-transform duration-300 hover:translate-y-[-2px]"
      >
