...
export default function Market() {
    ...
    const validator = (credentials) => {
        if (!credentials.quantity || !credentials.amount) {
        ...
        if (!credentials.stock || !credentials.stock.symbol) {
    ...
    const handleWishList = async (formData) => {
        ...
        console.log("Stock object:", credentials.stock);
        console.log("Quote object:", credentials.quote);
